...
<head>
    ...
    <title>Users - Royal Recipe Restaurant</title>
...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="users.php"><i class="fa fa-fw fas fa-users"></i>Users</a>
                            </li>
    ...
    if ($result->num_rows > 0) {
        ...
        $add2=$row["Address_l2"];
        $tel=$row["Tel"];
        $goto="removeuser.php?email=$email";
?>
        <tr>
        <td><?php echo $name;?></td>
