...
$id=$_GET['id'];
$_SESSION['id']=$id;
$sel="SELECT * FROM foods WHERE FoodID='$id'";
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="items.php">Manage Items</a>
                                        </li>
                                        </ul>
                                </div>
                            </li>
                    ...
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Edit an Item</h3>
                                    <p>The Image and Category must be reselect</p>
                                </div>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="updateitem.php" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" class="form-control" name="id" value="<?php echo $id;?>" require disabled>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Item Name</label>
                                                <input id="inputText3" type="text" class="form-control" name="name" value="<?php echo $name;?>" required>
                                            </div>
                                            ...
                                            <div class="custom-file mb-3">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <select class="form-control" id="input-select" value="<?php echo $cata;?>" name="category">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText4" type="number" class="form-control" value="<?php echo $price;?>" name="price" required>
                                            </div>

                                            <div class="form-group">
                                                <input type="submit" id="insert" value="Edit Item" class="btn btn-warning" name="submit">
