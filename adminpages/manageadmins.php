...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="manageadmins.php">Manage Admins</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="messages.php"><i class="fa fa-fw fas fa-envelope"></i>Messages</a>
                            </li>
    ...
    if ($result->num_rows > 0) {
        ...
        $goto="removeadmin.php?email=$email";
?>
        <tr>
        <td><?php echo $name;?></td>
        <td><?php echo $email;?></td>
        
        <td><a href="<?php echo $goto; ?>" class='btn btn-danger'>Remove</a></td>
    </tr>
