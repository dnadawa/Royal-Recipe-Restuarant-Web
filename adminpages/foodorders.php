...
<body>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="foodorders.php">Food Orders</a>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Food Orders</h2>
                            </div>
                        </div>
                    </div>
    ...
    if ($result->num_rows > 0) {
        ...
        $gotodel="shiporder.php?id=$id&food=$item";
...
?>
        ...
        <?php
            if($conf=="No"){?>
                <td><a href="<?php echo $gotodel; ?>" class='btn btn-warning'><i class="fas fa-exclamation"></i>&nbspPlaced</a></td>
           <?php }

            else{?>
                <td><label class="btn btn-success"><i class="fas fa-check"></i>&nbspShipped</label></td>
