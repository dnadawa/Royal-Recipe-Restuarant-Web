...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Items</h2>
                            </div>
                        </div>
                    </div>
    ...
    if ($result->num_rows > 0) {
        ...
        $gotodel="removeitem.php?id=$id";
        $edit="edititems.php?id=$id";
?>
        <tr>
        <td><?php echo $id;?></td>
        ...
        <td><a href="<?php echo $edit; ?>" class='btn btn-warning'>Edit</a></td>
        <td><a href="<?php echo $gotodel; ?>" class='btn btn-danger'>Remove</a></td>
    </tr>
